...
\begin{singlespace}
	...
	\section{Current State}
		...
		\subsection{Daniel Ross}
			...
			\includegraphics[height=0.05cm,natwidth=370,natheight=7]{images/Visible_Color_Spectrum_1_pixel.png}
	...
	\section{What's left to accomplish}
		...
		\subsection{Logan Wingard}
			...
			After reaching the 66\% goal and converting from RGB to wavelength, a color analysis function will get written.
		\subsection{Daniel Ross}
